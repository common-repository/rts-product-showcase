<div class="element-item col-xxl-<?php echo esc_html($settings['wpnp_product_grid_column']);?> col-lg-3 col-md-6 col-xs-1 grid-item">
	<div class="product-item content-overlay">
		<?php if(has_post_thumbnail()): ?>
			<div class="product-img">
			<?php
			if( $galCount == 1 || empty($gallery) ){
				?>
				...
				<div class="product-image--slider swiper">
					<div class="swiper-wrapper">
						...
						// Display the image URL
							...
							<a href="<?php the_permalink();?>" class="feature--image"><img src="<?php echo esc_url($link[0]);?>" alt="feature image"></a>
							</div>
							<?php
						}						
						?>
				...
				<div class="sale--box">
					...
					if( $is_feat ){
						?> <span class="hot">
							...
							esc_html_e( 'HOT!', 'wcproduct-showcase' );
						}?>
						</span>  <?php
					}
					?>
